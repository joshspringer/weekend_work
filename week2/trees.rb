...
# Hint: remember that with object oriented programming the object holds values in the attributes to describe its current state. Even when we aren't reading it's attributes, they should be up to date.
